...
#include "FG19_NetworkingDebugWidget.generated.h"
...
public:
	...
	// Max latency to add to packets. Using random value between min/max, when 0 = use min value
...
UCLASS()
class FG19_NETWORKING_API UFG19_NetworkingDebugWidget : public UUserWidget
{
	GENERATED_BODY()
public:
