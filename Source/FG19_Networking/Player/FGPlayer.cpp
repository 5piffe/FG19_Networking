...
void AFGPlayer::Tick(float DeltaTime)
{
	...
	{
		NewLocation = FMath::Lerp(GetActorLocation(), OldLocation, DeltaTime * InterpolationAlpha);
		NewRotation = FMath::Lerp(GetActorRotation(), OldRotation, DeltaTime * InterpolationAlpha);
